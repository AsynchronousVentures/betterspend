...
--> statement-breakpoint
ALTER TABLE "audit_idempotency_keys" ADD CONSTRAINT "audit_idempotency_keys_audit_log_id_audit_log_id_fk" FOREIGN KEY ("audit_log_id") REFERENCES "public"."audit_log"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "audit_idempotency_keys_org_action_key_unique" ON "audit_idempotency_keys" USING btree ("organization_id","action","idempotency_key");--> statement-breakpoint
