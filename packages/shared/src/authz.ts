...
export const PERMISSION_CATALOG = [
  ...
  {
    key: 'invoices:review_exceptions',
    group: 'Invoices',
    label: 'Review invoice exceptions',
  },
  ...
  { key: 'contracts:view', group: 'Contracts', label: 'View contracts' },
  { key: 'contracts:manage', group: 'Contracts', label: 'Manage contracts' },
  { key: 'catalog:view', group: 'Catalog', label: 'View catalog' },
  { key: 'catalog:manage', group: 'Catalog', label: 'Manage catalog' },
  { key: 'inventory:view', group: 'Inventory', label: 'View inventory' },
  { key: 'inventory:manage', group: 'Inventory', label: 'Manage inventory' },
  { key: 'supplier_risk:view', group: 'Supplier risk', label: 'View supplier risk' },
  { key: 'supplier_risk:manage', group: 'Supplier risk', label: 'Manage supplier risk' },
  {
    key: 'software_licenses:view',
    group: 'Software licenses',
    label: 'View software licenses',
  },
  {
    key: 'software_licenses:manage',
    group: 'Software licenses',
...
export const ACCESS_RESOURCE_SCOPE_TYPES = {
  ...
  catalog: ['entity'],
  inventory: ['global'],
  supplier_risk: ['entity'],
  software_license: ['entity'],
